...
spec = Gem::Specification.new do |s|
  s.name              = "rp-simhash"
  s.version           = Simhash::VERSION
  s.authors           = ["Alex Gusev", "Ryan Michael"]
  s.email             = ["alex.gusev@bookmate.ru", "kerinin@gmail.com"]
  s.homepage          = "http://github.com/ReturnPath/simhash"
